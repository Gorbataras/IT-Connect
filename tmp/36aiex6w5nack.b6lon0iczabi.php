...
<nav class="navbar navbar-expand-lg navbar-dark bg-success">
    <a class="navbar-brand" href="/"><img src="https://itconnect.greenrivertech.net/assets/img/grtech.jpg" class="img-responsive" style="height: 50px; width: 50px;"> ITConnect</a>
    ...
    <div class="collapse navbar-collapse" id="navbarText">
        ...
        <ul class="navbar-nav navbar-right">
                <li class="nav-item">
                     <a class="nav-link" id="education" href="http://www.greenriver.edu/academics/areas-of-study/bas-programs.htm" target="_blank">
