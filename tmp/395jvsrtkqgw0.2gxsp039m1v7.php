        ...
        <div class="row">
            ...
            <div class="col-md-3 mx-auto">
                <div class="container">
                    ...
                    <ul class="list-unstyled">
                        <li>
                           <p> Made with <a href="adminPage"><i class="fa fa-heart fa-2x" aria-hidden="true"></i></a> by <br> Green River College students</p><!--<a href="#!">Very long link 1</a>-->
                        </li>
                    </ul>
                </div>
            ...
            <div class="col-md-3 mx-auto">
                ...
                <ul class="list-unstyled">
                    ...
                    <li>
                        <a  href="https://www.greenriver.edu/students/academics/degrees-programs/bachelor-of-applied-science/bas-in-it-network-admin-security/">Network
